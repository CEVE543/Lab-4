...
```{julia}
mle_estimate = maximum_likelihood(bayes_model, NelderMead(); initial_params=[0.0, log(1.0), 0.0], maxiters=1_000)
...
```{julia}
map_estimate = maximum_a_posteriori(bayes_model, NelderMead(); initial_params=[0.0, log(1.0), 0.0], maxiters=1_000)
...
map_estimate_original = maximum_a_posteriori(original_model, NelderMead(); initial_params=[0.0, log(1.0), 0.0], maxiters=1_000)
